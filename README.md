...
* `node[:sumologic][:defaults][:category]` - You can specify a category
...
* `node[:sumologic][:defaults][:timezone]` - If you have timezone parsing
...
* `node[:sumologic][:defaults][:force_timezone]` - Set to *true* to force any
